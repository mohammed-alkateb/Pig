...
def test_add_high_score():
    """
        This function creates a new High_score object, calls the add_high_score method
        with several scores, and then checks that the method returns True when a new high
...
def test_get_high_scores():
    """
        This function creates a new High_score object, adds some high scores to it,
        and then checks that the method returns the highest score.
        """
    high_scores = High_score()
